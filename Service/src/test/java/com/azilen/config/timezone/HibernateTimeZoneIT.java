package com.azilen.config.timezone;

import com.azilen.AzilenNotificationServiceApp;
import com.azilen.repository.timezone.DateTimeWrapper;
import com.azilen.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM az_date_time_wrapper where id=%d", fieldName, id);
    }
